...
ActiveRecord::Schema[7.0].define(version: 2023_09_15_163901) do
  ...
  create_table "contact_proxies", force: :cascade do |t|
    t.bigint "member_id", null: false
    t.bigint "user_id", null: false
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["member_id"], name: "index_contact_proxies_on_member_id"
    t.index ["user_id"], name: "index_contact_proxies_on_user_id"
  end
  ...
  add_foreign_key "bills", "payers"
  add_foreign_key "bills", "splits"
  add_foreign_key "contact_proxies", "members"
  add_foreign_key "contact_proxies", "users"
